...
public class OfficerAddLetterController {
    ...
    @FXML public void initialize(){
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                ObservableList<String> sizes = FXCollections.observableArrayList("3.5 x 7 inch", "4 x 5 inch", "4 x 6.5 inch", "4 x 9 inch"
                        , "5 x 7 inch", "5 x 8 inch", "6 x 9 inch");
            ...
            if(!checkInput()) {
                ...
                if (confirm.finish()) {
                    ...
                    storageData.appendItem(receiverField.getText().trim(), buildingField.getText().trim(), floorField.getText().trim(), roomNumField.getText().trim()
                            ...
                            , fileName, officer.getCurrentAccount().getName());
