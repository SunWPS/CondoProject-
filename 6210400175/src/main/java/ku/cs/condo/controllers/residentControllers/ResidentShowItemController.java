...
public class ResidentShowItemController extends ResidentParentController{
    ...
    @FXML private Button homeBtn, rePassBtn, showItemOutBtn, logoutBtn, menuBtn, menuBtn2, fullInfoBtn;
    @FXML private Label usernameLabel;
    @FXML private TableView<Item> itemTable;
    @FXML private TableColumn<Item, String> roomNumCol, nameCol, senderCol, typeCol, dateCol;
    ...
    @FXML public void initialize(){
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                itemsData = FXCollections.observableList(storage.findItemByResident(getResident().getCurrentAccount(), "still"));
                ...
                dateCol.setCellValueFactory(new PropertyValueFactory<Item,String>("dateTime"));
