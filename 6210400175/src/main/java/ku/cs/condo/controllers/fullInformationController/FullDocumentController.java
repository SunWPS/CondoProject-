...
public class FullDocumentController {
    ...
    @FXML private Label receiverLabel, buildingLabel
            , roomNumLabel, sizeLabel, senderLabel, statusLabel, officerGetLabel, dateTimeLabel, importantLabel
    ...
    @FXML public void initialize() {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                importantLabel.setText(item.getImportantLv());
