...
public class AddResidentToDuplexController {
    @FXML private Label buildingLabel, floorLabel, typeLabel, roomNumLabel, errorLabel;
    @FXML private Button addBtn;
    @FXML private TextField nameField, nameField2;
        ...
        if(nameField.getText().trim().isEmpty()){
            ...
            if(of.finish()){
                ...
                if(!nameField2.getText().trim().isEmpty()){
                    room.setCoOwner(nameField2.getText().trim());
                }
                finishWork = true;
    ...
    public boolean finish(){ return  finishWork; }
